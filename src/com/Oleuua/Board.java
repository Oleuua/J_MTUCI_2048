...
public class Board {
    ...
    private int size; 						// размер сетки
    private int score; 						// счёт
    private int emptyTiles;					// кол-во клеток с 0-вым значением
    private int initTiles = 2; 				// стартовое значение(стандарт - 2)
    private boolean gameover = false; 		// флаг конца игры
    private String wonOrLost;				// флаг победы или поражения
    private boolean genNewTile = false;		// создаёт новую цифру при движении
    private List<List<Tile>> tiles;			// сама доска
