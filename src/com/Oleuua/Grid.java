...
public class Grid extends JPanel {
    ...
    private static void drawBoard(Graphics g) {
        ...
        g.fillRoundRect(-7, 0, Game.WINDOW.getWidth() - (WIN_MARGIN * 2), 320 + TILE_MARGIN, TILE_RADIUS, TILE_RADIUS);
    ...
    private static void drawTile(Graphics g, Tile tile, int x, int y) {
        ...
        int xOffset = x * (TILE_MARGIN + TILE_SIZE) + TILE_MARGIN - 7;
        ...
        if (Game.BOARD.getWonOrLost() != null && !Game.BOARD.getWonOrLost().isEmpty()) {
            ...
            g.fillRect(-7, 0, Game.WINDOW.getWidth(), Game.WINDOW.getHeight());
            g.setColor(ColorScheme.BRIGHT);
            g.setFont(new Font(FONT, Font.BOLD, 30));
            g.drawString("You " + Game.BOARD.getWonOrLost() + "!", 75, 150);
